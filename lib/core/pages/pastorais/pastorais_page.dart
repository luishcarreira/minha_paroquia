...
import 'package:minha_paroquia/core/pages/paroquia/adicionar_participantes_page.dart';
...
class PastoraisPage extends StatefulWidget {
  final String ref;
  final bool admin;
  const PastoraisPage({Key? key, required this.ref, required this.admin})
      : super(key: key);
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => CheckBoxExample(
                          refParoquia: widget.ref,
                        ),
                      ),
                    );
                  },
